    ...
    <body>
		...
		<th>Action</th>
			...
			<td style="text-align:center" width="200px">
				<?php 
				echo anchor(site_url('author/read/'.$author->id),'Read'); 
				echo ' | '; 
				echo anchor(site_url('author/update/'.$author->id),'Update'); 
				echo ' | '; 
				echo anchor(site_url('author/delete/'.$author->id),'Delete','onclick="javasciprt: return confirm(\'Are You Sure ?\')"'); 
				?>
			</td>
		</tr>
                <?php
